...
export const handleWeatherByGeolocation = () => {
    ...
    const success = async (pos) => {
        ...
        const response = await fetch(`https://api.geoapify.com/v1/geocode/reverse?lat=${crd.latitude}&lon=${crd.longitude}&lang=ru&apiKey=ffd56ddf11f54674b9b51faf181983b9`);
