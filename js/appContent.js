...
export const createContent = (data) => {
    ...
    const weatherInfoChanceOfRane = document.createElement('li');
    ...
    weatherInfoChanceOfRane.classList.add('weather-info__item');
    ...
    weatherInfoChanceOfRane.append(
    ...
    weatherInfoList.append(weatherInfoWind, weatherInfoPressure, weatherInfoHumidity, weatherInfoChanceOfRane);
